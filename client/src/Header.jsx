...
class Header extends React.Component {
  ...
  determineStars(number){
  	let result = 'starRating stars';
  	let stars = Math.floor((number-.25) * 2) + 1;
  	return result + stars;
  }
  render(){
  	let stars= this.determineStars(this.props.dressInfo.average_review_rating);
  	return (
	  	...
	  	<div>
	  	  <div className = "top">
	  	    ...
	  	    <button className = "heart_button" onClick={this.changeHeart}>
	  	      <div className = {this.state.heart}></div>
	  	    </button>
	  	  </div>
